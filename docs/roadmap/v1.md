...
| 1.5.5 | docker-compose.override production + déploiement | `docker compose -f docker-compose.yml -f instances/ldom/docker-compose.override.yml up -d` | [ ] |
| 1.5.6 | Validation OpenClaw branché | `/api/hub/chat/status` = `openclaw_configured: true`, message ↔ réponse | [ ] |
