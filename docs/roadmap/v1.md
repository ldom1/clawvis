...
|---|--------|---------|--------|
| 1.5.1 | Audit & snapshot hub-ldom | `docs/adr/0003-dombot-migration.md` | [ ] |
| 1.5.2 | `clawvis install` sur Dombot — créer `instances/ldom/` avec git remote = dombot-lab-hub | Test réel du flow install | [ ] |
| 1.5.3 | Migration hub-ldom → instances/ldom/ | nginx, authelia, memory, skills privés portés | [ ] |
| 1.5.4 | Symlinks OpenClaw — skills (par skill) + memory | `clawvis skills sync` + git hook post-merge | [ ] |
