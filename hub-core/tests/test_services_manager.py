...
from hub_core.services import ServiceManager, get_service_status, start_service, stop_service
...
class TestRAMEstimation:
    ...
    def test_ram_reasonable_values(self):
        ...
        for service_id, service in SERVICES.items():
            ...
            assert 50 < service.ram_mb < 500, f"{service.name} RAM estimate unreasonable"
